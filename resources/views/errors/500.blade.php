...
@section('content')
 <div style="min-height: 500px">
  <div style=" font-size: 70px" class="text-center">Błąd 500</div>
  <div style="font-size: 40px" class="text-center">Strona jest chwilowo niedostępna.</div>
 </div>
